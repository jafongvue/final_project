  ...
  <div>
    ...
    <v-card flat tile>
      ...
      >
        <div class="d-flex">
          <div id="css">
            <v-icon left class="primary--text mb-1">mdi-thumb-up</v-icon>
            {{ type }}
          </div>
          <v-spacer></v-spacer>
          <div class="mt-4">
            <v-row justify="end">
              <v-btn
                ...
                color="primary"
                dark
                to="/view.customer/recommendProduct"
              >
        ...
        <v-row>
          <v-col
            ...
            md="4"
            lg="3"
            v-for="(pro, idx) in re_products"
            :key="idx"
          >
            <ProductRecommend :pro="pro" />
          </v-col>
        </v-row>
      </v-container>
    </v-card>
    <v-card flat tile>
      <v-container class="grey lighten-4" fluid>
        <v-img src="/hot.png" height="150"></v-img>
      </v-container>
    </v-card>
    <v-card flat tile>
      <v-container
    ...
    <v-card flat tile>
      <v-container class="grey lighten-4" fluid>
        <v-img src="/new.png" height="150"></v-img>
      </v-container>
    </v-card>
    <v-card flat tile>
      <v-container
  ...
  data() {
    return {
      items: [
        ...
        {
          src: require("@/assets/images/products/img6.jpg"),
        },
        {
